...
<head>
  ...
  <title>Kenya MRS | Admin Dashboard</title>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">MRS Server Traffic</span>
                ...
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    ...
                    <div class="description-block margin-bottom">
                      ...
                      <h5 class="description-header">5020</h5>
                      <span class="description-text">Diagnosis</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      
                      <h5 class="description-header">1254</h5>
                      <span class="description-text">Prescriptions</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
